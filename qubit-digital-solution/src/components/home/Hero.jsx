        ...
        <div className="flex justify-between items-center gap-3">
          <div className="flex flex-col gap-2">
            ...
            <div className="text-[#5e616e] text-sm font-sans ">
              ...
              innovative design, and impactful marketing to elevate growth,
              engagement, and customer loyalty worldwide.
            </div>
            <Link
              href="/"
              className="text-md font-semibold text-[#f8f8fa] flex gap-1 items-center"
            >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="text-[#5e616e] text-sm font-sans ">
              Transforming ideas into stunning visuals with innovative designs,
              branding solutions, and creative strategies that captivate,
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-1 text-base text-[#f8f8fa] items-center  ">
              <BiTrendingUp size="2rem" />
              Digital Marketing Services
            </div>
            <div className="text-[#5e616e] text-sm font-sans ">
              Driving growth through targeted digital strategies, SEO, social
              media, and content marketing to boost brand visibility and
              maximize ROI.
            </div>
            <Link
              href="/"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-1 text-base text-[#f8f8fa] items-center  ">
              <AiOutlineCode size="2rem" />
              Web Development Services
            </div>
            <div className="text-[#5e616e] text-sm font-sans ">
              Building responsive, user-friendly websites with modern designs,
              seamless functionality, and optimized performance to enhance user
