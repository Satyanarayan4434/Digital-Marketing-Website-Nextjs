  ...
  return (
    <div className=" bg-[#d8d9df]">
      <div className="flex flex-col items-start justify-start pt-[2rem] gap-2 lg:ml-[5rem]">
        <div className="text-xl lg:text-4xl font-bold lg:w-[50rem] w-[20rem]">
          Empowering brands with websites, SEO, social media, content, and
          advertising solutions.
        </div>
        <div className="text-md font-sans font-light lg:w-[50rem] w-[20rem]">
        ...
        <Link href="/" className="flex gap-1 text-[#f18252] items-center">
